...
<div style="padding-top:6%">
    <!-- ################################################################################################ -->
    <?php
		echo "<table style='color:black'><tr><th>Car Id</th><th>Car Name</th><th>Manufucture Date</th><th>Price</th><th></th></tr>";
		...
		while($v_data=mysqli_fetch_array($v_query))
		{
			echo '<tr>
				...
				<td>'.$v_data[2].'</td>
				<td>'.$v_data[3].'</td>
				<td><a href="viewcar.php?car_id='.$v_data[0].'">Delete</a></td>	<td><a href="editcar.php?car_id='.$v_data[0].'">Edit</a></td>
				</tr>';
