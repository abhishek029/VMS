...
<div class="wrapper row1">
 ...
 <ul class="clear">
	  ...
	  <li><a href="editcar.php">Car</a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  ...
  <?php
		echo "<table style='color:black;back-color:red'> <tr><td>Item Idhjbjh</td><td>Car Id</td><td>Item Name</td><td>Price</td><td>Quantity</td><td>Reorder</td></tr>";
