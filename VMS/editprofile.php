...
if(isset($_SESSION["user"]))
{
	...
	include ("db.php");
	$query= "select * from customer where cust_id='".$v_session."'";
	...
	if(isset($_POST["submit"]))
	{
		...
		$query = "update customer set name = '".$v_name."', mobile = '".$v_no."', carname = '".$v_carname."', address = '".$v_add."',gender = '".$v_gen."', email = '".$v_email."'where cust_id = '".$v_data[0]."'";
...
<table width="200" border="1" style="background:#333333">
  ...
  <tr>
    <td>Gender</td>
    <td>:</td>
    <td><input name="txtgen" type="text" id="txtgen" value="<?php echo $v_data[7]; ?>" /></td>
  </tr>
  <tr>
    <td>E mail </td>
    <td>:</td>
  ...
  <tr>
    <td colspan="3" align="center"><label>
      <input name="submit" align="" type="submit" id="submit" value="Update" />
    </label></td>
    </tr>
</table>
</form>
