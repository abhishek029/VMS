...
<?php
	...
	if(isset($_POST["submit"]))
	{
		...
		$v_ITarget="images/".$_FILES["fpImage"]["name"];
	move_uploaded_file($_FILES["fpImage"]["tmp_name"],$v_ITarget);
	
	$v_file=fopen("add_Car.txt","a+");
	$v_data=$car_id.",".$v_model.",".$v_mdate.",".$v_price.",".$v_chasis.",".$v_ITarget.PHP_EOL;
	fwrite($v_file,$v_data);
		$v_file=file("add_car.txt");
		foreach($v_file as $v_data)
		{
...
<table width="200" border="1">
  ...
  <tr>
    ...
    <td><p>:</p>
      <p>&nbsp;</p></td>
    <td><label>
    <input name="fpimg" type="file" id="fpimg">
    </label></td>
  </tr>
  <tr>
    <td colspan="3"><label>
