...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  ...
  <?php
		echo "<table> <tr><th>Item Id</th><th>Car Id</th><th>Item Name</th><th>Price</th><th>Quantity</th><th>Reorder</th><th></th><th></th></tr>";
		...
		while($v_data=mysqli_fetch_array($v_query))
		{
			echo '<tr>
				...
				<td>'.$v_data[4].'</td>
				<td>'.$v_data[5].'</td>
				<td><a href="viewcar.php?item_id='.$v_data[0].'">Delete</a></td>	<td><a href="edititem.php?item_id='.$v_data[0].'">Edit</a></td>
