...
echo $v_session;
	...
	{
					mysqli_query($v_con,"delete from customer where cust_id=".$_GET["cust_id"]);
					header('Location:customer.php');
	}
	if(isset($_GET['car_id']))
	{
					$id = $_GET['car_id'];
					$que = mysqli_query($v_con,"delete from car where car_id='$id'");
	...
	{
					$id = $_GET['item_id'];
					$query = mysqli_query($v_con,"delete from items where item_id='$id'");
					if($query)
					{
...
<div>
    <!-- ################################################################################################ -->
    <?php
		echo "<table> <tr><th>Car Name</th><th>Manufucture Date</th><th>Price</th></tr>";
		
		$v_query=mysqli_query($v_con,"select * from car")or die (mysqli_error($v_con));
