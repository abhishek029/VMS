...
<div style="padding-top:8%">
  <?php	
  	echo "<table>";
		$v_query=mysqli_query($v_con,"select * from customer where cust_id='".$v_session."'")or die (mysqli_error($v_con));
		while($v_data=mysqli_fetch_array($v_query))
		{
			echo '<tr><th>Customer Id</th><th>:</th><th>'.$v_data[0].'</th></tr>
				<tr><th>Customer Name</th><th>:</th><th>'.$v_data[1].'</th></tr>
				<tr><th>Mobile</th><th>:</th><th>'.$v_data[4].'</th></tr>
				<tr><th>Car Name</th><th>:</th><th>'.$v_data[5].'</th></tr>
				<tr><th>Address</th><th>:</th><th>'.$v_data[6].'</th></tr>
				<tr><th>Gender</th><th>:</th><th>'.$v_data[7].'</th></tr>
				<tr><th>Email</th><th>:</th><th>'.$v_data[8].'</th></tr>';
		}
		echo "</table>";
	?>
	</div>
