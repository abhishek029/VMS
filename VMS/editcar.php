...
if(isset($_SESSION["user"]))
{
	...
	if(isset($_POST["submit"]))
	{
		...
		$query = "update car set model = '".$v_model."', mfg = '".$v_mdate."', price = '".$v_price."', chasis_no = '".$v_chasis."'where car_id = '".$v_data[0]."'";
...
<table width="200" border="1">
  <tr>
    ...
    <td>:</td>
    <td><label>
		<input  name="txtcarid" type="hidden" id="txtcarid" value="<?php echo $v_data[0]; ?>"/>
		<input name="txtmodel" type="text" id="txtmodel" value="<?php echo $v_data[1]; ?>"/>
    </label></td>
  </tr>
  <tr>
    ...
    <td>:</td>
    <td><label>
      <input name="txtdate" type="text" id="txtdate" value="<?php echo $v_data[2]; ?>"/>
    </label></td>
  </tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td>
      <input name="txtno" type="text" id="txtno" value="<?php echo $v_data[4]; ?>"/>
    </td>
  </tr>
  <tr>
    <td colspan="3"><label>
