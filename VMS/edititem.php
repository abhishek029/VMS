...
if(isset($_POST["submit"]))
	{
		$v_name = $_POST["txtcname"];
		$v_item = $_POST["txtname"];
		$price = $_POST["txtprice"];
		$qty = $_POST["txtqty"];
		$reorder = $_POST["reorder"];
		
		$query = "update items set car_model = '".$v_name."', item_name = '".$v_item."', price = '".$price."', qty = '".$qty."', reorder = '".$reorder."'where item_id = '".$v_data[0]."'";
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  ...
  <table width="200" border="1">
    <tr>
      ...
      <td>:</td>
      <td>
          <input name="txtcname" type="text" id="txtcname" value="<?php echo $v_data[1]; ?>">
      </td>
    </tr>
	<tr>
      <td>Item Name </td>
      <td>:</td>
      <td>
          <input name="txtname" type="text" id="txtname" value="<?php echo $v_data[2]; ?>">
      </td>
    </tr>
    <tr>
      <td>Price</td>
      <td>:</td>
      <td><label>
        <input name="txtprice" type="text" id="txtprice" value="<?php echo $v_data[3]; ?>">
      </label></td>
    </tr>
    <tr>
      <td>Quantity</td>
      <td>:</td>
      <td><label>
        <input name="txtqty" type="text" id="txtqty" value="<?php echo $v_data[4]; ?>">
      </label></td>
    </tr>
    <tr>
      <td>Reorder </td>
      <td>:</td>
      <td><label>
        <input name="reorder" type="text" id="reorder" value="<?php echo $v_data[5]; ?>">
      </label></td>
    </tr>
	<tr>
